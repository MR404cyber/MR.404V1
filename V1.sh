...
yellow='\033[33;1m'
sleep 1
toilet -f slant -F gay "T00Ls-MR.404V1" | lolcat
echo "\033[35;1m"
cal
date
echo ""      
...
echo "\033[37;1mkalimantan Whitehat Army"
echo "\033[33;1mKontak Me :  082331072836"
echo "\033[31;1mSupkreb Youtube:MR.404"
echo "\033[33;1mAnonymousCyberTeam" "\033[32;1m&" "\033[36;1mIndonesia Security Lite"
echo "\033[34;1m[============================[>"
sleep 1
echo ""
...
echo "0.> keluar"
echo "[===============================================]>"
read -p "root@T00Ls-MR.404V1]~#" bro
...
echo "\033[32;1mauthor: Mr.404"
echo "\033[33;1mTeam: Anonymous"
echo "\033[34;1mIndonesia Security Lite"
echo "\033[32;1mkalimantan white hat Army"
...
clear
echo "\033[31;1m"
cowsay ghostbusters.cow "Mr.404" 
figlet "Mr.B4J1N64N" | lolcat
apt update && apt upgrade
apt install python2
apt install python
